...
<cftry>
    ...
    <!--- Set category to cereals --->
    <cfset category = "cereals">
    ...
    <cfif categoryRatingStats.recordCount EQ 0>
        ...
        <cfoutput>No products found for cereals category</cfoutput>
        <cfabort>
    </cfif>
    ...
    <cfchart format="png" chartwidth="800" chartheight="600" 
             title="Rating Distribution for Cereals"
             backgroundcolor="##ffffff" databackgroundcolor="##f8f9fa" showlegend="no"
             name="chartData">
        <cfchartseries type="bar" seriescolor="##28a745">
