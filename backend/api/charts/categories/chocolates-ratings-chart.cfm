...
<cftry>
    ...
    <!--- Set category to chocolates --->
    <cfset category = "chocolates">
    ...
    <cfif categoryRatingStats.recordCount EQ 0>
        ...
        <cfoutput>No products found for chocolates category</cfoutput>
        <cfabort>
    </cfif>
    ...
    <cfchart format="png" chartwidth="800" chartheight="600" 
             title="Rating Distribution for Chocolates"
             backgroundcolor="##ffffff" databackgroundcolor="##f8f9fa" showlegend="no"
             name="chartData">
        <cfchartseries type="bar" seriescolor="##6f42c1">
